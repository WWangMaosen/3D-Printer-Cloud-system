...
<div class="login">
    ...
    <#--<label class="layui-form-label" style="width:160px;padding: 0px 22px 0px 180px;font-style: italic;margin-top:15px"><a href="/register" style="font-size:13px">还没有账号？注册账号</a></label>-->
