        ...
        layui.use('table', function () {
            ...
            table.on('tool(Device)',function (obj){
                ...
                if(obj.event === 'checkstatus'){
                  start(eid); //请求发送状态数据
                  checkstatus( dname +'实时状态','/checkdevvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvice?eid=' + eid, 700, 450 )
